...
/*##################################################################### */
    ...
    *  PSU_CRL_APB_RPLL_FRAC_CFG_DATA                              0x3b

    * Fractional control for the PLL
    * (OFFSET, MASK, VALUE)      (0XFF5E0038, 0x8000FFFFU ,0x8000003BU)
    */
	PSU_Mask_Write(CRL_APB_RPLL_FRAC_CFG_OFFSET,
		0x8000FFFFU, 0x8000003BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Fractional value for the Feedback value.
    *  PSU_CRF_APB_VPLL_FRAC_CFG_DATA                              0x3b

    * Fractional control for the PLL
    * (OFFSET, MASK, VALUE)      (0XFD1A0040, 0x8000FFFFU ,0x8000003BU)
    */
...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0070, 0x013F3F07U ,0x01010F02U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x7D6DFFFFU ,0x55000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x7D6DFFFFU, 0x55000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFC7AFU ,0x00B00006U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFC7AFU, 0x00B00006U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x00000910U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x00000910U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x00000602U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL6_OFFSET,
		0x03FFFFFFU, 0x00000602U);
/*##################################################################### */
