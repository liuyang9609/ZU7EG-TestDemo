...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0038 0x8000FFFF 0x8000003B
    ...
    mask_write 0XFD1A0040 0x8000FFFF 0x8000003B
}
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01010F02
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x7D6DFFFF 0x55000000
    ...
    mask_write 0XFF180208 0xFFFFC7AF 0x00B00006
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x00000910
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x00000602
